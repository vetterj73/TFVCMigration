...
namespace CyberStitchBenchmark
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (!_aligner.ChangeProduction(_mosaicSetProcessing, _panel))
                {
            ...
            while (!bDone)
            {
                ...
                {
                    _cycleCount++;
                    Output("Before Image Stitching");
                    RunStitch();
                    Output("After Image Stitching");

                    if (_mosaicSetProcessing.SaveAllStitchedImagesToDirectory("c:\\temp\\") == false)
        ...
        private static void SetupMosaic(bool bOwnBuffers, bool bMaskForDiffDevices)
        {
            ...
            _mosaicSetProcessing = new ManagedMosaicSet(_panel.PanelSizeX, _panel.PanelSizeY, 2592, 1944, 2592, cPixelSizeInMeters, cPixelSizeInMeters, bOwnBuffers);
        ...
        private static void RunStitch()
        {
            ...
            {
                ManagedMosaicLayer pLayer = _mosaicSet.GetLayer(i);
